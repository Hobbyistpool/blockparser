...
#if defined BEECOIN
    static const size_t gHeaderSize = 80;
    static auto kCoinDirName = ".beecoinv2";
    static const uint32_t gExpectedMagic = 0x70352205;
#endif
...
static void parseTX(
    ...
    if(!skip) {
        ...
        #if defined(PEERCOIN) || defined(CLAM) || defined(JUMBUCKS) || defined(PAYCON) || defined(BEECOIN)
